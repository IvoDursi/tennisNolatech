...
abstract class $ReservationCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, DateTime date, String field});
}
...
class _$ReservationImpl implements _Reservation {
  _$ReservationImpl(
      {required this.name, required this.date, required this.field});
  ...
  @override
  String toString() {
    return 'Reservation(name: $name, date: $date, field: $field)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, date, field);
...
abstract class _Reservation implements Reservation {
  factory _Reservation(
      ...
      required final String field}) = _$ReservationImpl;
